...
The next recommended build is **Slice 15R**, because Slice 15Q has now made streaming drift, weak-label posture, and recalibration triggers explicit, and the highest-leverage move is to close the AML pivot with one flagship benchmark, demo, and paper-safe proof pack.
