...
- adaptive human onboarding through mission-control chat, with visible captured onboarding state, direct dataset-path handling, confirmation before the first run, and bounded local semantic extraction for messy first-contact messages
