"""Optional local-LLM advisory helper for Slice 07 completion review."""
...
from .models import CompletionControls
...
class CompletionLocalAdvisor:
    """Narrow structured-JSON client for optional completion-surface refinement."""
