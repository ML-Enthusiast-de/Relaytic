"""Optional local-LLM advisory helper for investigation specialists."""
...
from .models import InvestigationControls
...
class InvestigationLocalAdvisor:
    """Narrow structured-JSON client for optional local LLM amplification."""
...
def build_local_advisor(
    *,
...
) -> InvestigationLocalAdvisor | None:
    ...
    return InvestigationLocalAdvisor(
        LocalAdvisorConfig(
