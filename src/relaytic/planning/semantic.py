"""Optional local-LLM advisory helper for Strategist planning."""
...
from .models import PlanningControls
...
class PlanningLocalAdvisor:
    """Narrow structured-JSON client for optional Strategist amplification."""
