"""Optional local-LLM advisory helper for intake interpretation."""
...
from .models import IntakeControls
...
class IntakeLocalAdvisor:
    """Narrow structured-JSON client for optional intake interpretation."""
