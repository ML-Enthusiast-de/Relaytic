...
- latest model-competitiveness slice: 15L, benchmark truth hardening, trace-identity conformance, eval-surface parity, leakage audits, and paper-claim gates
- latest performance-recovery slice: 15L, benchmark truth hardening, trace-identity conformance, eval-surface parity, leakage audits, and paper-claim gates
- next performance-recovery slice: 15M, competitive specialization and benchmark generalization guards
