...
- next planned paper follow-on: no mandatory paper-track implementation slice before Slice 16A; final human upload work remains author metadata replacement, local TeX compile/PDF inspection, and clean tag-target confirmation
