...
- latest roadmap update: Paper Track P0 through P24 is implemented. P24 added protocol-complete manuscript generation, primary-source citation repairs, metric/split/semantic consistency reports, a redesigned non-comparative Figure 4, clean PDF/source preflight, and an exact-revision final-build command.
...
- latest paper-track slice: P24, release integrity and revision-locked artifact generation over the reviewed P23 source/PDF bundle
...
- next paper action: commit the reviewed P24 source, run `paper-release-integrity --final`, inspect the exact-revision PDF, select the public tag, and perform the human upload action
