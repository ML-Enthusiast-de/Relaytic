...
- latest roadmap update: Paper Track P0 through P13 is completed, and Paper Track P14 is now the required final arXiv-source hardening path before Academy work resumes; `docs/build_slices/phase_paper_track.md` is the execution brief
...
- latest paper-track slice: P13, `paper_release_manifest.json`, `paper_arxiv_submission_checklist.md`, `paper_attention_pack.md`, `paper_public_claims_allowed.json`, `docs/paper/relaytic_aml_arxiv_draft.md`, `docs/paper/references.bib`, and `docs/paper/tables/*`
...
- next planned paper follow-on: P14, final arXiv source bundle, converted figures, author metadata placeholders, clean release-candidate tag target, and clone-proof submission package audit
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P14 closes the final arXiv upload-source gap
...
With Slice 15Z-R and Paper Track P0-P13 now landed, the next high-leverage frontier follow-ons are:
