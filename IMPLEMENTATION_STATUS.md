...
- latest model-competitiveness slice: 15H, first-class competitive family stack, adapter readiness/version reporting, and family eligibility/probe artifacts
- latest performance-recovery slice: 15H, first-class competitive family stack, adapter readiness/version reporting, and family eligibility/probe artifacts
- next performance-recovery slice: 15I, portfolio search engine and serious budget doctrine
