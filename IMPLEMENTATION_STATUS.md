...
- latest paper-track slice: P11, `docs/paper/relaytic_aml_draft.md`, `docs/paper/figures/`, `paper_claim_lint_report.json`, `paper_limitations_matrix.json`, and Paper Track P12 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P12 through P13 complete dry-run and arXiv proof gates
...
With Slice 15Z-R and Paper Track P0-P11 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P12 through P13, run clean-clone proof and only then attempt an arXiv release
