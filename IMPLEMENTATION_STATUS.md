...
- latest paper-track slice: P7, `paper_graph_baseline_manifest.json`, `paper_graph_feature_table.json`, `paper_graph_model_shadow_scorecard.json`, `paper_graph_competitive_search_trace.json`, `paper_graph_publishability_gate.json`, and Paper Track P8 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P8 through P13 complete benchmark breadth, paper draft, dry run, and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P7 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P8, decide AMLSim/Elliptic2 support and record whether the hard graph/subgraph tracks are runnable for the first paper
- Paper Track P9 through P13, add operational metrics, preserve P7's graph-neural non-competitiveness finding unless recovered with stronger proof, generate reproducible tables, write a claim-linted draft, run clean-clone proof, and only then attempt an arXiv release
