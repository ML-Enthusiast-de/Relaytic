...
- latest paper-track slice: P15, `relaytic release-safety paper-system-eval`, `paper_system_behavior_eval.json`, `paper_agent_handoff_eval.json`, `paper_no_lost_user_eval.json`, `paper_claim_gate_case_studies.json`, `paper_system_eval_manifest.json`, and `paper_system_eval_summary.md`
...
- latest paper-system-evaluation slice: P15 measures guide onboarding, partial-run recovery, rowless and redacted external-agent handoff, MCP-style server discovery, local-LLM advisory boundaries, and P11/P12/P13 claim-gate behavior; all 11 required deterministic protocol checks pass, raw rows and private paths stay out of committed system-evaluation reports, and P13 now gates the release pack on this measured system-behavior evidence.
