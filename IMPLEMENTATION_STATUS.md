...
- latest performance-recovery slice: 15G, objective contracts, split correctness, metric-materialization auditing, and benchmark-truth gating
- next performance-recovery slice: 15H, first-class competitive family stack
