...
- next planned paper follow-on: no implementation slice remains in the current paper track; final public submission still needs replacement of the release-tag placeholder, author page-by-page PDF review, arXiv package upload, and a clean tag target
