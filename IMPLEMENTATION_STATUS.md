...
- latest paper-track slice: P8-B, `elliptic2_competitive_budget_contract.json`, `elliptic2_revclassify_reference_scorecard.json`, `elliptic2_relaytic_candidate_search_trace.json`, `elliptic2_repeated_seed_scorecard.json`, `elliptic2_split_robustness_report.json`, `elliptic2_publishability_gate.json`, and Paper Track P8-C as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P8-C through P13 complete modern-reference parity/cohort proof, operational proof, paper draft, dry run, and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P8-B now landed, the next high-leverage frontier follow-ons are:

- Paper Track P8-C, attempt faithful neural modern-reference parity, reconcile the RevTrack-evaluable cohort with the current official core, and add a stronger identity/leakage-resistant partition before allowing P9
- Paper Track P9, add operational metrics only after P8-C determines whether modern subgraph evidence can support the ambitious paper story rather than merely a supporting baseline row
