...
- latest model-competitiveness slice: 15J, temporal engine, event-preserving blocked splits, lagged baseline ladders, and sequence-shadow posture
- latest performance-recovery slice: 15J, temporal engine, event-preserving blocked splits, lagged baseline ladders, and sequence-shadow posture
- next performance-recovery slice: 15K, calibration, thresholds, and decision optimization
