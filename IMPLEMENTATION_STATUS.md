...
- latest roadmap update: Paper Track P0 through P13 is now completed as the required path before Academy work, with `docs/build_slices/phase_paper_track.md` as the execution brief
...
- next planned academy follow-on: 16A, capability registry and capability cards, now that Paper Track P13 has completed claim-safe arXiv proof gates
...
- claim-safe arXiv release packaging through `relaytic release-safety paper-release`, with `docs/paper/relaytic_aml_arxiv_draft.md`, `docs/paper/references.bib`, generated paper tables, `paper_release_manifest.json`, `paper_arxiv_submission_checklist.md`, `paper_attention_pack.md`, and `paper_public_claims_allowed.json`
