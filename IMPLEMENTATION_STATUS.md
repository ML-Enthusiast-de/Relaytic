...
- completed paper-track slices: Paper Track P0 baseline freeze and Paper Track P1 public-surface cleanup, compatibility retention reporting, and Relaytic API/tool aliases
- flagship frontier direction: Relaytic-AML, the AML and financial-crime edition of Relaytic
- next recommended slice: Paper Track P2, paper thesis and claim contract before benchmark implementation
...
- latest paper-track slice: P1, public-surface cleanup, compatibility retention reporting, modern Relaytic aliases for legacy API/tool names, and Paper Track P2 as the next target
- latest paper-surface cleanup slice: P1, `paper_public_surface_hygiene_report.json`, `legacy_compatibility_retention_report.json`, `paper_repo_cleanup_scorecard.json`, modern Relaytic aliases for legacy API/tool names, and Paper Track P2 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P2 through P13 complete the benchmark and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P1 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P2, freeze the paper thesis, research questions, contribution story, allowed claims, blocked claims, and benchmark acceptance doctrine before benchmark implementation starts
- Paper Track P3 through P5, freeze the dataset registry, then build the PaySim-style temporal and Elliptic-style graph benchmark paths that can produce honest paper rows
