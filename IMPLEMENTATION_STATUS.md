...
- latest model-competitiveness slice: 15K, calibration strategy selection, operating-point contracts, threshold-search artifacts, review-budget optimization, and abstention posture
- latest performance-recovery slice: 15K, calibration strategy selection, operating-point contracts, threshold-search artifacts, review-budget optimization, and abstention posture
- next performance-recovery slice: 15L, benchmark truth hardening and paper-claim gates
