...
- latest roadmap update: Paper Track P0 through P22 is completed, and `docs/build_slices/phase_paper_strengthening.md` now records planned Paper Track P23 as an optional novelty/distinction hardening pass before final human paper-upload actions. Slice 16A remains the next academy target if P23 is skipped or completed.
...
- latest paper-track slice: P22, author-review layout hardening and regression closure over the P21 final source/PDF bundle
...
- next planned paper follow-on: optional Paper Track P23 novelty and adjacent-systems distinction hardening before public submission, focused on making the distinction from detector papers, AML LLM triage, agentic SAR/compliance assistants, agent-governance layers, MLOps tracking, model cards, datasheets, reproducibility checklists, and agent benchmarks explicit without adding benchmark numbers or stronger detector claims
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P23 is either skipped or completed
...
- the completed Paper Track P0 through P22, covering repo/public-surface cleanup, paper thesis contract, benchmark dataset registry, PaySim-style temporal evidence, Elliptic-style graph evidence, strong tabular and graph baselines, a dedicated PaySim competitive rerun/publishability gate, AMLSim/Elliptic2 support decisions, operational AML metrics, reproducible paper tables, claim-linted paper drafting, clean-clone dry run, claim-safe paper release gating, final arXiv source release-candidate packaging, measured system-behavior proof for user/agent handoff, deterministic failure-case evaluation, governance machinery ablation, formal governance-invariant positioning, hosted external-score governance proof, hosted-score case-study integration, PaySim selection-story plus reader-guidance polish, final source/PDF preflight plus release changelog, and author-review layout hardening
- planned optional Paper Track P23, which should harden the novelty and adjacent-systems distinction before submission by framing Relaytic-AML as a local-first AML evaluation-evidence governance layer around detectors and agents, not a detector replacement, generic experiment tracker, model-card substitute, SAR-writing assistant, agent benchmark, or broad agent-governance product
...
With Slice 15Z-R and Paper Track P0-P22 now landed, and optional Paper Track P23 registered for final paper positioning if selected, the next high-leverage frontier follow-ons are:

- optional Paper Track P23 novelty and adjacent-systems distinction hardening before public paper submission, without changing benchmark numbers or detector-claim boundaries
- Slice 16A capability registry and capability cards after P23 is skipped or completed, with final arXiv upload treated as a human release action rather than another implementation slice
