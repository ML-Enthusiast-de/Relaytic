...
- completed paper-track slices: Paper Track P0 baseline freeze through Paper Track P25 evidence disclosure, plus Paper Track P26 factual evidence/gate separation, validation-subsplit disclosure, finalist-tie correction, and immutable public-commit release support
- flagship frontier direction: Relaytic-AML, the AML and financial-crime edition of Relaytic
- next recommended action: commit and push the reviewed P26 source candidate, run the exact-revision final build from that immutable public commit, inspect the release bundle, and then perform the arXiv upload. A public tag is optional and must be verified if used.
...
- latest roadmap update: Paper Track P0 through P26 is implemented. P26 adds strict factual evidence-cell and separate claim-gate contracts, exact validation-subsplit disclosure, displayed-precision finalist consistency, and commit-based exact-revision release support.
...
- latest paper-track slice: P26, evidence/gate separation and validation-subsplit disclosure over the P25 source/PDF bundle
