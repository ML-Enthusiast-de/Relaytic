...
- latest paper-track slice: P8-D, `paper_p8d_thesis_decision.json`, `paper_p8d_evidence_role_matrix.json`, `paper_p8d_reprovisioning_decision.json`, `paper_p8d_claim_rewrite_plan.json`, and Paper Track P9 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P9 through P13 complete operational proof, reproducible tables, paper draft, dry run, and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P8-D now landed, the next high-leverage frontier follow-ons are:

- Paper Track P9, add operational metrics under the P8-D narrowed thesis boundary, keeping Elliptic2 out of performance-contribution claims
