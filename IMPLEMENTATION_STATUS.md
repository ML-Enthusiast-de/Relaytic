...
- completed paper-track slices: Paper Track P0 baseline freeze, verification report, and hard-claim blocked starting posture
- flagship frontier direction: Relaytic-AML, the AML and financial-crime edition of Relaytic
- next recommended slice: Paper Track P1, legacy public-surface cleanup before benchmark/paper implementation
...
- latest paper-track slice: P0, `paper_track_baseline_manifest.json`, `paper_track_verification_report.json`, targeted P0 regression, and Paper Track P1 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P1 through P13 complete the benchmark and arXiv proof path
...
With Slice 15Z-R and Paper Track P0 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P1, clean stale public-surface language and compatibility leakage so the repo reads as current Relaytic-AML rather than inherited corr2surrogate or surrogate-era scaffolding
- Paper Track P2 through P5, freeze the paper thesis and dataset registry, then build the PaySim-style temporal and Elliptic-style graph benchmark paths that can produce honest paper rows
