...
- latest paper-track slice: P5, `elliptic_graph_loader_manifest.json`, `elliptic_graph_provenance_report.json`, `elliptic_temporal_split_report.json`, `elliptic_graph_claim_scope.json`, `elliptic_paper_result_row.json`, and Paper Track P6 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P6 through P13 complete the strong baseline, competitive-budget, graph benchmark, paper draft, dry run, and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P5 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P6, build the strong tabular baseline suite with explicit smoke, baseline, competitive, and release budgets
- Paper Track P6-A through P13, rerun PaySim competitively, add graph baselines, AMLSim/Elliptic2 support decisions, operational metrics, reproducible tables, a claim-linted paper draft, clean-clone dry run, and only then an arXiv release
