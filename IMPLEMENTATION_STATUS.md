...
- next recommended slice: Paper Track P0, freeze and commit the 15Z-R baseline before benchmark/paper implementation
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P0 through P13 complete the benchmark and arXiv proof path
...
With Slice 15Z-R now landed and the pre-Academy AML paper/release freeze explicit, the next high-leverage frontier follow-ons are:

- Paper Track P0, freeze and commit the 15Z-R baseline with a verification manifest before any new benchmark or paper implementation starts
