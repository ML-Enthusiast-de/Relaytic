...
- completed paper-track slices: Paper Track P0 baseline freeze, Paper Track P1 public-surface cleanup, compatibility retention reporting, Relaytic API/tool aliases, and Paper Track P2 thesis/claim contract freeze
- flagship frontier direction: Relaytic-AML, the AML and financial-crime edition of Relaytic
- next recommended slice: Paper Track P3, benchmark dataset registry and access manifest before benchmark runners
...
- latest paper-track slice: P2, `paper_thesis_contract.json`, `paper_claim_taxonomy.json`, `paper_related_work_seed.json`, `docs/paper/paper_thesis.md`, and Paper Track P3 as the next target
...
- next planned academy follow-on: 16A, capability registry and capability cards, after Paper Track P3 through P13 complete the benchmark and arXiv proof path
...
With Slice 15Z-R and Paper Track P0-P2 now landed, the next high-leverage frontier follow-ons are:

- Paper Track P3, freeze the dataset registry, access posture, split contracts, local file expectations, hashes when available, and blocked reasons before benchmark runners start
- Paper Track P4 through P5, build the PaySim-style temporal and Elliptic-style graph benchmark paths that can produce honest paper rows
