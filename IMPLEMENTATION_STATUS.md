...
- latest model-competitiveness slice: 15E, execution DAG, freshness contracts, recompute planning, and artifact reuse
...
- next planned model-competitiveness follow-on after Slice 15E: 15F, research-imported architecture candidates with replay and shadow trials
...
- a post-Slice-15F capability-academy track with capability registries, replay and shadow trials, arena promotion scorecards, hunt campaigns, seeded exploration, provider feedback, and non-core specialist recruitment or retirement
