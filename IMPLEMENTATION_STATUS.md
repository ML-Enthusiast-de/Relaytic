...
- latest model-competitiveness slice: 15I, staged portfolio search, budget-profile separation, and finalist search doctrine
- latest performance-recovery slice: 15I, staged portfolio search, budget-profile separation, and finalist search doctrine
- next performance-recovery slice: 15J, temporal engine and time-aware competitiveness
