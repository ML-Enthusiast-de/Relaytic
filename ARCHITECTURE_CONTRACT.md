...
- `src/relaytic/aml/` owns Slice 15O deterministic AML graph construction, counterparty-network profiling, typology detection, suspicious-subgraph scoring, entity-case expansion artifacts, Slice 15V raw graph, flattened graph, and subgraph ingestion artifacts, Slice 15W AML temporal delayed-label, positive-unlabeled, threshold-drift, time-window, and public-claim gating artifacts, and Slice 15X AML evaluation-environment scorecards
...
- `src/relaytic/guide/` owns Slice 15V-A no-lost guidance, safe action-menu synthesis, artifact shortlists, optional local-LLM guide summaries, graceful partial-run status fallback support, and redacted external LLM context-pack exports without replacing mission control, assist, handoff, workspace, or benchmark as sources of truth
...
- `docs/build_slices/phase_15n.md`
- `docs/build_slices/phase_15o.md`
...
- `docs/specs/aml_frontier_contract.md`
...
Current AML proof artifact names from Slice 15R-A:
...
Current AML productization artifact names from Slice 15S:
...
Current AML business-value artifact names from Slice 15T:
...
Current AML graph-loader artifact names from Slice 15V:
...
Current guide and context-pack artifact names from Slice 15V-A:
...
Current AML temporal weak-label artifact names from Slice 15W:
...
Current AML evaluation-environment artifact names from Slice 15X:
...
Current pre-Academy repo credibility artifact names from Slice 15Z:
...
Current paper-freeze artifact names from Slice 15Z-R:
...
Current paper-track PaySim artifact names from Paper Track P4:
...
Current paper-track tabular baseline artifact names from Paper Track P6:
...
Current paper-track Elliptic graph baseline artifact names from Paper Track P7:
...
Current paper-track reproducible table artifact names from Paper Track P10:
...
Current paper-track external dry-run artifact names from Paper Track P12:
...
Current paper-track final preflight artifact names from Paper Track P21:
