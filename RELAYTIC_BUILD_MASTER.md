...
- the Paper Track P0 through P20 is now completed as the mandatory pre-Academy paper path plus the hosted-score proof, case-study integration, and paper-polish stages; the remaining triggerable Paper Track P21 path is recorded in `docs/build_slices/phase_paper_strengthening.md`, and capability-academy slices may start from Slice 16A if the final paper-preflight path is not being pursued
...
- Paper Track P0 through P20 now come before Academy work because Relaytic needed a clean repo surface, real numeric benchmark table, external dry run, claim-linted paper, claim-safe public release pack, arXiv-compatible source release candidate, measured user/agent handoff evidence, deterministic failure-case evidence, governance-ablation evidence, formal governance-invariant positioning, hosted-score governance proof, hosted-score case-study integration, and PaySim/story/reader-guidance polish before capability evolution resumed
