...
- Paper Track P3 is now implemented and freezes dataset source/access posture, license notes, local file expectations, hashes for present local fixtures, split contracts, blocked reasons, and no-auto-download policy; Paper Track P4 is the next target
...
- next planned academy follow-on: Slice 16A, after Paper Track P4 through P13 complete the benchmark, paper-draft, dry-run, and arXiv release gates
