...
- Paper Track P0 through P15 now come before Academy work because Relaytic needed a clean repo surface, real numeric benchmark table, external dry run, claim-linted paper, claim-safe public release pack, arXiv-compatible source release candidate, and measured user/agent handoff evidence before capability evolution resumed
