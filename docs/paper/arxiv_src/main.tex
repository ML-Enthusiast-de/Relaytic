...
A representative metric cell is compact enough to audit directly. The public table uses the alias \nolinkurl{PS-PR}, while the underlying artifact keeps the longer machine identifier.
...
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.16}
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}X >{\raggedright\arraybackslash}X@{}}
\toprule
