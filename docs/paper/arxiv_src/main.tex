...
\textbf{Hosted external-score case study.}
...
\Needspace{20\baselineskip}
\textbf{Table 9. Evidence routing examples.}
...
\Needspace{20\baselineskip}
\textbf{Table 10. Rowless handoff and interrupted-run recovery examples.}
...
\Needspace{20\baselineskip}
\textbf{Table 11. Reproducibility contract.}
