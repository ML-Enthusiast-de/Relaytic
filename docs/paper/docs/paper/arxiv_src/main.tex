...
\midrule
Failure-case pack & Required P16 report is absent. & release gate & paper\_failure\_case\_manifest & Paper release blocks until the failure-case report is generated. & not available \\
\bottomrule
\end{tabularx}
\end{minipage}
\end{center}
...
\midrule
Hosted score integration & P19-B report absent & paper\_external\_score\_integration\_manifest & Paper release blocks until the hosted-score case-study pack is generated. \\
\bottomrule
\end{tabularx}
\end{minipage}
\end{center}
