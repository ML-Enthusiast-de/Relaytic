...
- [ ] Confirm public wording status is `blocked_public_wording`.
...
- [ ] Confirm the release pack was regenerated after source commit `c9110410b004936ed261c58064b9fdbad79ca67d` if the evidence changed.
