...
- Status: `blocked_pending_p18_repairs`
- Invariant status: `blocked`
- Adjacent-systems status: `blocked`
- Current invariant count: `7`
- Adjacent family count: `9`
- Evidence-completeness check passed: `False`
- Next slice: `Paper Track P18 repair`
