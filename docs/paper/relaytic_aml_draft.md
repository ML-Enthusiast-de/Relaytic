...
| PaySim competitive | test PR-AUC | 0.638773 | supporting-only | `paper-cell:paysim_p6a_competitive_selected.test_pr_auc` |
...
| Elliptic graph-feature | test PR-AUC | 0.668756 | supporting-only | `paper-cell:elliptic_p7_selected_graph_feature_baseline.test_pr_auc` |
