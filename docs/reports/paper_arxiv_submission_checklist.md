...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `7d2ff161d600736cb3e5ff58fb149b0c30a2f762`; rerun the manifest after final edits if the source evidence changes.
