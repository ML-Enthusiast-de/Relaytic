...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `bc17443aee985caad345026ea13363ceda5d6e0d`; rerun the manifest after final edits if the source evidence changes.
