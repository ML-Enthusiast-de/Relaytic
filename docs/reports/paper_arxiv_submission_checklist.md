...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `b32ce8fca5837d52c3f05ffcc7969e2a22fb0ab1`; rerun the manifest after final edits if the source evidence changes.
