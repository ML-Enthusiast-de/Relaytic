...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `80cafec76cc43925129c92914bc3ac0f7cb051c9`; rerun the manifest after final edits if the source evidence changes.
