...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `a3ac8d290f5e3c6a0ded25cf66b0c39647eacbf0`; rerun the manifest after final edits if the source evidence changes.
