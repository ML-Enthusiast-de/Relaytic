...
- [ ] Confirm the final tag target contains the release-pack artifacts generated from base commit `3d2d5174c1ec88eba3d5af5720fe7b1ed4087edc`; rerun the manifest after final edits if the source evidence changes.
