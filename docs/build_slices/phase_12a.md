...
- the mission-control surface introduced in Slice 11B and expanded through Slices 11C, 11D, 11E, 11F, and 11G, together with later assist surfaces, should expose pulse history directly rather than leaving pulse state as a side artifact
