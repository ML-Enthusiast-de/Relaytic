...
- Paper Track P0 through P16 now come before Academy work because the current freeze pack deliberately blocked hard AML and SOTA claims; Relaytic first cleaned public surfaces, ran relevant benchmark tracks, challenged weak first-pass rows with competitive leakage-safe budgets, generated real numeric evidence, drafted a claim-safe paper, proved a clean paper-smoke path, produced a claim-safe P13 paper release pack, produced a P14 arXiv-compatible source bundle, added P15 measured user/agent handoff evidence, and added P16 deterministic failure-case evidence before expanding into capability evolution
- Paper Track P17 through P21 remain as triggerable paper-strengthening follow-ons in `docs/build_slices/phase_paper_strengthening.md`: P17 adds governance ablations, P18 formal invariants and adjacent-systems positioning, P19 an optional hosted-detector workflow demonstration, P20 PaySim/story/visual polish, and P21 final source/PDF preflight. These stages must run one at a time and preserve the evaluation-lab claim boundary.
...
- Paper Track P16 is implemented; Paper Track P17 should start only when the user triggers Stage 2.
...
- next planned paper follow-on: Paper Track P17 governance machinery ablation pack is the next triggerable paper-strengthening slice; final human upload work remains human PDF review, arXiv upload-package confirmation, and clean tag-target confirmation if no further strengthening slice is pursued
...
- P16 is implemented. P17 is the next paper-strengthening slice if the user triggers Stage 2; otherwise Slice 16A remains the academy target.
